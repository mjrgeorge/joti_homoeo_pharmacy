...
const Footer = () => {
    ...
    return (
        <footer className="container bg-transparent text-center">
            ...
            <p className="text-dark m-2">© {year} LifeTest. All rights reserved. Created by <a className="text-info" href="https://mjrgeorge.netlify.app/" target="_blank">mjrgeorge</a></p>
        </footer>
    );
};
