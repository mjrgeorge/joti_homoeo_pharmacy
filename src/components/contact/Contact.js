            ...
            <div className="row mb-4">
                <div className="col-lg-6 shadow-lg text-danger d-flex justify-content-center align-items-center flex-column">
                    <div className="text-center m-2">
                        ...
                        <h5>Call Me On</h5>
                        <h5><a className="text-decoration-none text-info" href="tel:+8801314942635">+8801314942635</a></h5>
                    </div>
                    <div className="text-center m-2">
                        <h3><FontAwesomeIcon icon={faEnvelopeOpen} /></h3>
                        <h5>Email</h5>
                        <h5><a className="text-decoration-none text-info" href="mailto:mjrgeorge@gmail.com">jotihomoeo32@gmail.com</a></h5>
                    </div>
                    <div className="text-center m-2">
